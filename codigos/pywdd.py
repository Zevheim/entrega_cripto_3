...
if __name__ == "__main__":
    ...
    with open('/home/sebastian/Desktop/lab_3_cript/salida.dic', errors='ignore') as f: #Diccionario reemplazado por el rockyou modificado.
        S = []
        for l in f:
            S.append(l.strip())
    #ssid name
    ...
    #Authenticator MAC (AP)
    apMac = a2b_hex("b0487ad2dc18")     #mac del primer handshake
    #Station address: MAC of client
    cliMac = a2b_hex("eede678cdf8b")    #mac del segundo handshake
    #The first MIC
    mic1 = "1813acb976741b446d43369fb96dbf90"
    #The entire 802.1x frame of the second handshake message with the MIC field set to all zeros. Se tomó el frame entero, y se reemplazo el campo de la mic por ceros.
    ...
    #The entire 802.1x frame of the third handshake message with the MIC field set to all zeros. Se tomó el frame entero, y se reemplazo el campo de la mic por ceros.
    ...
    #The entire 802.1x frame of the forth handshake message with the MIC field set to all zeros. Se tomó el frame entero, y se reemplazo el campo de la mic por ceros.
